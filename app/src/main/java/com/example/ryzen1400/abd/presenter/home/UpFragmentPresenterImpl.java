...
public class UpFragmentPresenterImpl implements BasePresenter {


    SoftReference<UpFragmentViewImpl> view;
    public UpFragmentPresenterImpl(UpFragmentViewImpl upFragmentViewImpl){
        view = new SoftReference<UpFragmentViewImpl>(upFragmentViewImpl);
    }
